...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(http, toDoService, router) {
        this.http = http;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        var toDosObservable = this.toDoService.getAllToDos();
        toDosObservable.subscribe(function (toDosData) {
            _this.toDos = toDosData;
            console.log("toDo completed: " + JSON.stringify(_this.toDos[0].completed));
        });
    };
    DashboardComponent.prototype.setActiveToDo = function (toDo, index) {
        this.currentToDo = toDo;
        this.currentIndex = index;
    };
    DashboardComponent.prototype.completeToDo = function (toDo) {
...
var LogoutComponent = /** @class */ (function () {
    function LogoutComponent(http, constants, router) {
        this.http = http;
        this.constants = constants;
        this.router = router;
    }
    ...
    LogoutComponent.prototype.logOut = function () {
        ...
        var newLocal = this.http.post(this.constants.getRootURL() + "/logout", null);
        newLocal.subscribe(function () {
...
var PetComponent = /** @class */ (function () {
    function PetComponent(http, petService, router) {
        this.http = http;
    ...
    PetComponent.prototype.ngOnInit = function () {
        var _this = this;
        var petObservable = this.petService.getPet();
        petObservable.subscribe(function (petData) {
            _this.pet = petData;
            document.getElementById("progress-bar").setAttribute("style", "width: " + _this.pet.hungerLevel * 10 + "%");
            console.log("this pet: " + JSON.stringify(_this.pet));
        });
    };
    PetComponent.prototype.feedPet = function () {
        var _this = this;
    ...
    PetComponent.prototype.setMood = function (hungerLevel) {
        var mood = "";
        if (hungerLevel < 1) {
            mood = "Not so good";
        }
    ...
    PetComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
...
var PetService = /** @class */ (function () {
    ...
    PetService.prototype.getPet = function () {
        return this.http.get("http://localhost:8080/api/pet");
    };
    PetService.prototype.feed = function (pet) {
...
var PomodoroComponent = /** @class */ (function () {
    ...
    PomodoroComponent.prototype.toggle = function (pageNumber) {
        this.pageNumber = pageNumber;
    };
    PomodoroComponent.prototype.increaseFocusTime = function () {
        this.workDuration += 1;
        this.minutes = this.workDuration - 1;
    };
    PomodoroComponent.prototype.decreaseFocusTime = function () {
        this.workDuration -= 1;
        this.minutes = this.workDuration - 1;
    };
    PomodoroComponent.prototype.increaseBreakTime = function () {
        this.breakDuration += 1;
    };
    PomodoroComponent.prototype.decreaseBreakTime = function () {
        this.breakDuration -= 1;
    };
    PomodoroComponent.prototype.start = function () {
        var _this = this;
        this.interval = setInterval(function () { return counter(); }, 1000);
        var counter = function () {
            _this.seconds--;
            if (_this.seconds == -1) {
                _this.minutes--;
                if (_this.minutes == -1) {
                    _this.message = "Great job";
                }
            }
        };
        //  stop(){
...
var ToDoService = /** @class */ (function () {
    function ToDoService(http, constants) {
        this.http = http;
        this.constants = constants;
    }
    ...
    ToDoService.prototype.complete = function (toDo) {
