package org.launchcode.pandaplanner;

import org.launchcode.pandaplanner.auth.controllers.UserController;
...
public class AuthenticationFilter implements HandlerInterceptor {
    ...
    private static final List<String> whitelist = Arrays.asList("/signin", "/register", "/logout", "/landing", "/css");
